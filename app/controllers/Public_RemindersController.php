...
class Public_RemindersController extends BaseController {

	public function getRemind()
	{
		$this->data['meta']->title = 'Forgot Password';
		$this->data['active_menu'] = 'forgot';

		return View::make('public.reminder.forgot', $this->data);
	}
