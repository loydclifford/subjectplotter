...
return array(
    ...
    'Student does not exist' => 'Student does not exist',
    'Thank you' => 'Thank you',
    ...
    // messages
    'Student not found with email :mail' => 'Student not found with email :mail',
    'Student not found with id :id' => 'Student not found with id :id',
    ...
    'Student not activated' => 'Student not activated',
    'Student is suspended for :time minutes' => 'Student is suspended for :time minutes',
    'student_is_banned' => 'Student is banned',
    'student_not_found' => 'Student not found',
    'login_already_exists' => 'Student with this login already exists',
    'account_activation_error' => 'There was a problem activating this account',
    'student_does_not_exists' => 'Student does not exist',
    ...
    'wrong_credentials' => 'Incorrect student name, email or password.',
    ...
    'already_confirmed' => 'Cannot attempt activation on an already activated student.',
    'wrong_confirmation' => 'Wrong confirmation code.',
    'password_forgot' => 'The information regarding password reset was sent to your email.',
    'wrong_password_forgot' => 'Student not found.',
