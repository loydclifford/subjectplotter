...
class CourseYears_Courses_Subjects_Seeder extends Seeder {
    ...
    public function run()
    {
        ...
        DB::table('course_subject_schedules')->truncate();
        DB::table('course_subjects')->truncate();
        DB::table('courses')->truncate();
        DB::table('course_years')->truncate();
        ...
        foreach (scandir($base_cy_c_s_dir) as $file_name)
        {
            ...
            if ( ! $course_year)
            {
                ...
                $course_year->course_code = $course->course_code;
...
//                $lab = array_get($data, 'Lab');
                ...
                foreach ($school_years as $school_year)
                {
                    ...
                    $course_subject->subject_code = $subject_code;
                    $course_subject->save();
                }
            }
        }
