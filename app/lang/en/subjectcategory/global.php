...
return array(
    ...
    'Subjectcategory does not exist' => 'Subjectcategory does not exist',
    'Thank you' => 'Thank you',
    ...
    'Account:' => 'Account:',
    'Subjectcategory permissions' => 'Subjectcategory permissions',

    // messages
    'Subjectcategory not found with email :mail' => 'Subjectcategory not found with email :mail',
    'Subjectcategory not found with id :id' => 'Subjectcategory not found with id :id',
    ...
    'Subjectcategory not activated' => 'Subjectcategory not activated',
    'Subjectcategory is suspended for :time minutes' => 'Subjectcategory is suspended for :time minutes',
    'subjectcategory_is_banned' => 'Subjectcategory is banned',
    'subjectcategory_not_found' => 'Subjectcategory not found',
    'login_already_exists' => 'Subjectcategory with this login already exists',
    'account_activation_error' => 'There was a problem activating this account',
    'subjectcategory_does_not_exists' => 'Subjectcategory does not exist',
    ...
    'wrong_credentials' => 'Incorrect subjectcategoryname, email or password.',
    ...
    'already_confirmed' => 'Cannot attempt activation on an already activated subjectcategory.',
    'wrong_confirmation' => 'Wrong confirmation code.',
    'password_forgot' => 'The information regarding password reset was sent to your email.',
    'wrong_password_forgot' => 'Subjectcategory not found.',
