...
return array(
    ...
    // messages
    'Room not found with email :mail' => 'Room not found with email :mail',
    'Room not found with id :id' => 'Room not found with id :id',
    ...
    'Room not activated' => 'Room not activated',
    'Room is suspended for :time minutes' => 'Room is suspended for :time minutes',
    'room_is_banned' => 'Room is banned',
    'room_not_found' => 'Room not found',
    'login_already_exists' => 'Room with this login already exists',
    'account_activation_error' => 'There was a problem activating this account',
    'room_does_not_exists' => 'Room does not exist',
    ...
    'wrong_credentials' => 'Incorrect roomname, email or password.',
    ...
    'already_confirmed' => 'Cannot attempt activation on an already activated room.',
    'wrong_confirmation' => 'Wrong confirmation code.',
    'password_forgot' => 'The information regarding password reset was sent to your email.',
    'wrong_password_forgot' => 'Room not found.',
