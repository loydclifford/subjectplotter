...
Route::group(array('prefix'=>'admin', 'before'=>'admin_auth'), function()
{
    ...
    Route::group(array('prefix'=>'grade-entry'), function()
    {
        ...
        Route::get('/{grade_entry}/edit', 'Admin_GradeEntryController@getEdit');
        Route::post('/{grade_entry}/edit', 'Admin_GradeEntryController@postEdit')->before('csrf');

        Route::get('/{grade_entry}/view', 'Admin_GradeEntryController@getView');
